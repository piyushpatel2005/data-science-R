...
The data for this analysis can be downloaded from [Project info](https://www.coursera.org/learn/probability-intro/supplement/1E7zQ/project-information) page.
...
The Behavioral Risk Factor Surveillance System (BRFSS) is a collaborative project between different states in the United States (US) and participating US territories and the Centers for Disease Control and Prevention (CDC).
...
In order to conduct the BRFSS, states obtain samples of telephone numbers from CDC. States then review their sampling methodology with a state statistician and CDC to make sure data collection procedures are in place to follow the methodology. If any change in sampling methodology is considered, states consult with CDC before making changes. 
...
**Research quesion 3:**
      Smoking is not advised for a perfect health. So what are the effects of these 2 factors over the general health? Lets see how they affect the general health.
...
How many of these poor health  people can't afford the medical cost and do not have insurance'?
...
This means around 9.1 % of the people with poor health are unable to go to the doctors due to lack of money and health insurance.
...
As the article in Time had suggested one third, my research doesn't agree with that. One possible reason may be due to the fact that the 
article is of 2014 and this data is of 2013. Also several other factors may have been influential like the method of sampling could have caused this bias.
...
p4 + xlab("Total fruits consumption") +ylab("Total Vegetables consumption") +ggtitle("Relationship between the fruits, vegetables consumed and health")
```

The first plot refers to the exercise and the second one refers to the amount of vegetables and fruits consumed.
**Note:** The plot takes a little bit of time). Also zoom the plot for better understanding.
...
This proportion rate goes on increasing with the better quality of health. As only few people have excellent health, the red color is not that easily visible. But one can notice that it is prominent in the areas where both the veggies and fruits are high. This association could also occur due to sheer luck or may be a result of severe other factors that were not considered.
...
It is clearly evident that the more than half of the people having poor health have smoked atleast 100 ciggarettes. While this proportion factors goes on decreasing as the health quality increases. So there is a negative association of smoking on health. There may be other factors also that may have contributed to this, such as the alcohol consumption, lack of exercise , food habits ,etc.
